  ...
  return (
    <>
      ...
      <TextBlock heading="Why Visit Taniti?">
        <p>
          Taniti is a small island in the Pacific with rich biodiversity,
          beautiful beaches, and an emerging tourism scene. Experience a
          peaceful escape with adventure at your doorstep.
        </p>
      </TextBlock>
